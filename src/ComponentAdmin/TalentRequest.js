          ...
          <div className="w-[95%] ml-1 mt-[19px] h-[620px]  rounded-[5px] border-[#E3E7EB] border-[1px] 5xl:w-[2000px] 6xl:w-[95%] 4xl:w-[1500px]">
            <div className="w-[97%] flex justify-between ml-[20px] mt-[19px] h-[60px]  rounded-[5px] bg-[#F4F4F6] 5xl:w-[1950px] 6xl:w-[97%] 4xl:w-[1450px]">
              <div className="w-[90%] pl-3 h-[40px] bg-[#fff] justify-between rounded-[4px] ml-[10px] mt-[10px] flex items-center border-[#E3E7EB] border-[1px] 5xl:w-[1650px] 6xl:w-[90%] 4xl:w-[1150px]">
                ...
                <input
                  className=" w-[96%] h-[36px]  outline-none placeholder:text-[#38761D] placeholder:tracking-[0.8px] placeholder:text-[14px] font-[300] 5xl:w-[1600px] 6xl:w-[97%] 4xl:w-[110px]"
                  type="text"
            ...
            <table className="w-[97%] table ml-[17px] mt-[30px] text-center h-[450px] 5xl:w-[1950px] 4xl:w-[1450px] 6xl:w-[97%]">
