    ...
    <>
      <div className=" bg-[#fff]  w-[100%] h-[150vh]">
        <div className="pt-[8%] pb-[20px] 3xxl:ml-[10px] 1halfxl:ml-[30%] ml-[30%] 5xl:ml-[40%] 4xl:ml-[37%]">
          <h2 className=" 3xxl:ml-[30px] 1halfxl:ml-[90px] text-[#38761D] 3xxl:whitespace-nowrap text-[36px] text-left ml-[90px] mb-[50px] font-[600] ">
            Admin Dashboard
          </h2>
          <div className=" bg-white 3xxl:w-[390px] 1halfxl:w-[512px] rounded-[20px] shadow-xl  shadow-[rgba(0, 0, 0, 0.1)] w-[512px]  h-[640px] ">
            <div className=" pt-5 ">
              <h1 className=" text-[30px]  text-center text-[#2F2E2E] font-[600] opacity-90">
                Log In
              </h1>
              ...
              <div className=" w-[420px] 3xxl:w-[300px] 1halfxl:w-[420px]  mt-[30px] mb-[20px] h-[50px]  border-[#565758] border-opacity-[16%] ml-[50px]  outline-none rounded-[2px]  border-[1px] ">
                <div className=" w-[230px] 1halfxl:w-[230px] 1halfxl:ml-[90px] ml-[90px] 3xxl:ml-[30px] h-[50px] flex items-center justify-evenly">
                  ...
                  <h3 className=" text-[#181819] text-[14px] ">
                    Sign up with Google
                  </h3>
                </div>
              </div>
              <div className="w-[466px] 3xxl:w-[350px] 1halfxl:w-[466px] rounded-[4px] mt-[16px] items-center flex justify-between">
                <h3 className=" w-[200px] 3xxl:w-[150px] 1halfxl:w-[200px] border-[1px] h-[0px] ml-[50px] border-[#E6E7E9] ">
                  {/* intentional break */}
                </h3>
                <h4 className=" text-[#181819] m-[6px] text-opacity-[42%] text-[14px]">
                  OR
                </h4>
                <h3 className=" w-[200px] border-[1px] 1halfxl:w-[200px] 3xxl:w-[150px] h-[0px] border-[#E6E7E9] ">
                  {/* intentional break */}
                </h3>
              </div>
              <form
                ...
                autoComplete="on"
                className="ml-[3rem] mt-[33px]"
                action=""
              >
                <label
                  className=" text-[14px] text-[#181819] text-opacity-[90%]  "
                  htmlFor="Username"
                >
                  Username
                </label>
                ...
                <div className=" w-[420px] 3xxl:w-[300px] 1halfxl:w-[420px] flex justify-between items-center">
                  <label
                    className=" text-[14px] text-[#181819] text-opacity-[90%] pb-[8px] "
                    htmlFor="Password"
                  >
                    Password
                  </label>
                  <label className=" text-[14px] text-[#38761D] w-[140px] items-center flex justify-evenly text-opacity-[90%] pb-[8px] ">
                    Remember me
                    <input
                      className=" w-[13px] h-[13px] border-[#38761D]"
                      type="checkbox"
                      checked={rememberMe}
                ...
                <div className="w-[160px] flex justify-between items-center">
                  <input
                    className=" w-[13.5px] h-[13.5px] border-[#919294]"
                    type="checkbox"
                    required
                  />
                  <label
                ...
                > */}
                  <div
                    className="mt-[35px] 3xxl:w-[300px] 1halfxl:w-[420px] tracking-[2px] w-[420px] rounded-[2px] h-[50px] bg-[#38761D] text-center pt-[11px] opacity-90 text-[#fff]"
                    onClick={handleLogin}
                  >
                    <h1>SUBMIT</h1>
                  </div>
