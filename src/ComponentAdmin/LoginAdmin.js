  ...
  return (
    <>
      <div className=" bg-[#fff] w-[100%] h-[150vh]">
        <div className="pt-[8%] pb-[20px] ml-[30%] 5xl:ml-[40%] 4xl:ml-[37%]">
          <h2 className=" text-[#38761D] text-[36px] text-left ml-[90px] mb-[50px] font-[600] ">Admin Dashboard</h2>
          <div className=" bg-white rounded-[20px] shadow-xl  shadow-[rgba(0, 0, 0, 0.1)] w-[512px]  h-[640px] ">
            <div className=" pt-5 ">
              ...
              <div className=" w-[420px]   mt-[30px] mb-[20px] h-[50px]  border-[#565758] border-opacity-[16%] ml-[50px]  outline-none rounded-[2px]  border-[1px] ">
              ...
              <div className="w-[466px] rounded-[4px] mt-[16px] items-center flex justify-between">
                <h3 className=" w-[200px] border-[1px] h-[0px] ml-[50px] border-[#E6E7E9] ">{/* intentional break */}</h3>
                <h4 className=" text-[#181819] m-[6px] text-opacity-[42%] text-[14px]">OR</h4>
                <h3 className=" w-[200px] border-[1px] h-[0px] border-[#E6E7E9] ">{/* intentional break */}</h3>
              </div>
              <form onSubmit={handleSubmit} autoComplete="on" className="ml-[3rem] mt-[33px]" action="">
                ...
                <br />
                <input required className=" mt-[8px] w-[420px] border-[#565758] border-opacity-[16%] mb-[20px] h-[50px] pl-[14px] bg-[#fff] outline-none rounded-[2px]  border-[1px]  " type="text" value={username} onChange={handleUsernameChange} />
                <br />
                ...
                <input required className=" w-[420px] border-[#565758] border-opacity-[16%] mb-[20px] h-[50px] pl-[14px] bg-[#fff] outline-none rounded-[2px]  border-[1px]  " type="password" value={password} onChange={handlePasswordChange} />
                <br />
                ...
                <Link
                  ...
                  to="/applicant"
                >
                  <div className="mt-[35px] tracking-[2px] w-[420px] rounded-[2px] h-[50px] bg-[#38761D] text-center pt-[11px] opacity-90 text-[#fff]">
                    <h1>SUBMIT</h1>
                  </div>
                </Link>
              </form>
