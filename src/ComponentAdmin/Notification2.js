    ...
    <>
      <div className="bg-[#fff] w-[100%] h-[160vh] ">
        ...
        <div className="3xxl:ml-[18%] 3xxl:overflow-x-auto md:ml-[18rem] ml-[18rem] pt-[30px] ">
          ...
          <div className=" ml-[10px] border-[#E3E7EB] border-[1px] opacity-90 bg-[#38761D] h-[312px] mt-[40px] rounded-[5px] w-[920px] 5xl:w-[2000px] 6xl:w-[1300px] 4xl:w-[1500px] ">
            <h3 className="  pb-[10px] pl-[18px] h-[50px] pt-[10px] text-[18px] bg-[#fff] text-[#38761D] font-[400]  w-[920px] 5xl:w-[2000px] 6xl:w-[1299px] 4xl:w-[1499px]">Today</h3>
            ...
            <div className="  h-[65px]  w-[920px] 5xl:w-[2000px] 6xl:w-[1300px] 4xl:w-[1500px]">
              <div className=" text-[14px] text-[#fff] font-[400] mt-[23px] w-[920px] flex justify-evenly 5xl:w-[1950px] 5xl:justify-between 5xl:ml-[20px]  ">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M20.742 14.9004H14.2586C12.8336 14.9004 11.667 16.067 11.667 17.492V26.9587C11.667 28.1671 12.5337 28.6837 13.592 28.092L16.867 26.267C17.217 26.0754 17.7837 26.0754 18.1253 26.267L21.4003 28.092C22.4587 28.6837 23.3253 28.1671 23.3253 26.9587V17.492C23.3337 16.067 22.167 14.9004 20.742 14.9004Z"
          ...
          <div className=" ml-[10px] border-[#E3E7EB] border-[1px] h-[490px] mt-[40px] rounded-[5px] w-[920px] 5xl:w-[2000px] 6xl:w-[1300px] 4xl:w-[1500px] ">
            <h3 className=" mt-[15px] pb-[10px] pl-[18px] text-[18px] text-[#38761D] font-[400] border-[#E3E7EB] border-b-[1px] w-[920px] 6xl:w-[1300px] 5xl:w-[2000px] 4xl:w-[1500px]">Earlier</h3>
            <div className="  h-[65px] border-[#E3E7EB] border-b-[1px] w-[920px] 5xl:w-[2000px] 6xl:w-[1300px] 4xl:w-[1500px]">
