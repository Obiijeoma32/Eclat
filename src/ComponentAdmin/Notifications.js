    ...
    <>
      <div className="bg-[#fff] w-[100%] h-[160vh] ">
        ...
        <div className=" ml-[18rem] pt-[30px] ">
          ...
          <div className=" ml-[10px] border-[#E3E7EB] border-[1px] h-[169px] mt-[40px] rounded-[5px] w-[920px] 5xl:w-[2000px]  4xl:w-[1500px]">
            <h3 className=" mt-[15px] pb-[10px] pl-[18px] text-[18px] text-[#38761D] font-[400] border-[#E3E7EB] border-b-[1px] w-[920px] 5xl:w-[2000px]">Today</h3>
