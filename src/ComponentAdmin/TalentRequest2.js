    ...
    <>
      <div className="bg-[#fff] w-[100%] h-[150vh] ">
        ...
        <div className="3xxl:ml-[18%] 3xxl:overflow-x-auto md:ml-[18rem] ml-[18rem] pt-[30px] ">
          ...
          <div className="w-[95%] ml-1 mt-[19px] h-[620px]  rounded-[5px] border-[#E3E7EB] border-[1px] 5xl:w-[2000px] 6xl:w-[95%] 4xl:w-[1500px]">
            <div className="w-[97%] flex justify-between ml-[20px] mt-[19px] h-[60px]  rounded-[5px] bg-[#F4F4F6] 5xl:w-[1950px] 6xl:w-[97%] 4xl:w-[1450px]">
              <div className="w-[90%] pl-3 h-[40px] bg-[#fff] justify-between rounded-[4px] ml-[10px] mt-[10px] flex items-center border-[#E3E7EB] border-[1px] 5xl:w-[1700px] 6xl:w-[90%] 4xl:w-[1200px]">
                ...
                <input
                  className=" w-[96%] h-[36px]  outline-none placeholder:text-[#38761D] placeholder:tracking-[0.8px] placeholder:text-[14px] font-[300] 5xl:w-[1620px] 6xl:w-[96%] 4xl:w-[1120px] "
                  type="text"
            ...
            <table className="w-[97%] table ml-[17px] mt-[30px] text-center h-[450px] 5xl:w-[1950px] 6xl:w-[100%] 4xl:w-[1450px]">
              <thead className="text-[15px] pb-[10px] opacity-90 font-[400px] text-[#38761D]">
                <tr className="w-[100%] flex justify-between  items-center border-b-[#E3E7EB] border-b-[1px] 5xl:w-[1950px] 6xl:w-[97%]  4xl:w-[1450px]">
              ...
              <tbody className="text-[13px] w-[100%] whitespace-nowrap opacity-90 font-[400px] text-[#4D708D] 5xl:w-[1950px] 6xl:w-[97%] 4xl:w-[1450px]">
                <tr className="w-[100%] flex justify-between items-center h-[50px] 5xl:w-[1950px] 6xl:w-[97%] 4xl:w-[1450px] ">
                  <td className="">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="0.5" y="0.5" width="17" height="17" rx="4.5" stroke="#E3E7EB" />
                    </svg>
                ...
                <tr className="h-[50px] w-[100%] flex justify-between items-center   bg-[#F9F9FA] 5xl:w-[1950px] 6xl:w-[97%] 4xl:w-[1450px]">
                  <td>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="0.5" y="0.5" width="17" height="17" rx="4.5" stroke="#E3E7EB" />
                    </svg>
                ...
                <tr className="h-[50px]  w-[100%] flex justify-between items-center 5xl:w-[1950px] 6xl:w-[97%] 4xl:w-[1450px] ">
                  <td>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="0.5" y="0.5" width="17" height="17" rx="4.5" stroke="#E3E7EB" />
                    </svg>
