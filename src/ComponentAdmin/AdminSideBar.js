...
function AdminSideBar({ children }) {
  ...
  const adminMenu = [
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M14 17.5C17.866 17.5 21 14.366 21 10.5C21 6.63401 17.866 3.5 14 3.5C10.134 3.5 7 6.63401 7 10.5C7 14.366 10.134 17.5 14 17.5Z" stroke="white" strokeWidth="2" strokeMiterlimit="10" />
          <path
  ...
  return (
    <>
      <div className="w-[260px] pt-[150px] 3xxl:hidden 1halfxl:block 820xxl:hidden fixed pl-[39px] h-[100vh] bg-[#38761D] opacity-90">
      ...
      <div className=" 3xxl:block  hidden 820xxl:hidden w-[40px] ">
        {!side && (
          <div onClick={() => setSideBar(true)} className="fixed w-[60px]  3xxl:h-full z-40 pt-[100px] pl-[17px] bg-[#38761d]   opacity-90">
            <div>
              ...
              <div className=" h-[60px]">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  />
                  <path d="M18.541 17.5C20.0857 17.4989 21.6078 17.87 22.9786 18.5819C24.3494 19.2938 25.5285 20.3255 26.416 21.5897" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div className=" h-[60px]">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className=" h-[60px]">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  />
                  <path d="M24.5011 13.8154C21.3099 15.6617 17.6871 16.6312 14.0003 16.6254C10.314 16.6312 6.69184 15.6621 3.50098 13.8164" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M12.6875 13.125H15.3125" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div className=" h-[60px]">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className=" h-[60px]">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path opacity="0.2" d="M14 17.5H10.5V14L18.375 6.125L21.875 9.625L14 17.5Z" fill="" />
                  <path d="M14 17.5H10.5V14L21 3.5L24.5 7L14 17.5Z" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M18.375 6.125L21.875 9.625" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                  <path
                    d="M23.625 13.125V22.75C23.625 22.9821 23.5328 23.2046 23.3687 23.3687C23.2046 23.5328 22.9821 23.625 22.75 23.625H5.25C5.01794 23.625 4.79538 23.5328 4.63128 23.3687C4.46719 23.2046 4.375 22.9821 4.375 22.75V5.25C4.375 5.01794 4.46719 4.79538 4.63128 4.63128C4.79538 4.46719 5.01794 4.375 5.25 4.375H14.875"
                    stroke="white"
                    strokeWidth="1.2"
        ...
        {side && (
          <div className=" z-20 w-[100%] fixed bg-[#000] bg-opacity-20  top-0 left-0 h-[150vh] ">
            <div onClick={() => setSideBar(false)} className="  w-[300px] pt-[100px]  pl-[40px] h-[150vh] bg-opacity-90 bg-[#38761d]">
              {adminMenu.map((item, index) => (
                <NavLink className={({ isActive }) => (isActive ? " text-[#fff]" : " text-[#fff] opacity-60 ")} to={item.path} key={index}>
                  <div className="flex mb-[32px]  items-center w-[120px]  ">
                    <span>{item.icon}</span>
                    <h2 className=" text-left ml-[17px] text-[18px] whitespace-nowrap">{item.name}</h2>
                  </div>
