    ...
    <>
      <div className="bg-[#fff] w-[100%] h-[150vh] ">
        ...
        <div className=" ml-[18rem] pt-[30px] ">
          ...
          <div className="flex justify-between w-[950px] mt-[25px] ml-1 mr-[30px] 5xl:w-[2000px] 4xl:w-[1500px] ">
          ...
          <div className="w-[950px] ml-1 mt-[19px] h-[575px]  rounded-[5px] border-[#E3E7EB] border-[1px] 5xl:w-[2000px] 4xl:w-[1500px]">
            <div className="w-[920px] flex justify-between ml-[20px] mt-[19px] h-[60px]  rounded-[5px] bg-[#F4F4F6] 5xl:w-[1950px] 4xl:w-[1450px]">
              <div className="w-[650px] pl-3 h-[40px] bg-[#fff] justify-between rounded-[4px] ml-[10px] mt-[10px] flex items-center border-[#E3E7EB] border-[1px] 5xl:w-[1650px] 4xl:w-[1150px]">
                ...
                <input
                  className=" w-[590px] h-[36px]  outline-none placeholder:text-[#38761D] placeholder:tracking-[0.8px] placeholder:text-[14px] font-[300] 5xl:w-[1600px] 4xl:w-[1100px] "
                  type="text"
            ...
            <table className="w-[920px] ml-[17px] mt-[30px] text-center h-[450px] 5xl:w-[1950px] 4xl:w-[1450px]">
