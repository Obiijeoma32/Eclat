    ...
    <>
      <div className="bg-[#fff] w-[100%] h-[160vh] ">
        ...
        <div className=" 3xxl:ml-[18%] 3xxl:overflow-x-auto  md:ml-[18rem] pt-[30px] ">
          ...
          <div className="  ">
            <div className="flex  justify-between w-[95%] 6xl:w-[95%] mt-[25px] ml-1 mr-[30px] 5xl:w-[2000px]  4xl:w-[1500px] ">
            ...
            <div className=" w-[95%]  ml-1 mt-[19px] h-[654px]  rounded-[5px] border-[#E3E7EB] border-[1px] 6xl:w-[95%] 5xl:w-[2000px] 4xl:w-[1500px]">
              <div className="w-[97%] flex justify-between ml-[20px] mt-[19px] h-[60px]  rounded-[5px] bg-[#F4F4F6] 6xl:w-[97%] 5xl:w-[1950px] 4xl:w-[1450px]">
                <div className="w-[90%] pl-3 h-[40px] bg-[#fff] justify-between rounded-[4px] ml-[10px] mt-[10px] flex items-center border-[#E3E7EB] border-[1px] 6xl:w-[90%] 5xl:w-[1700px] 4xl:w-[1200px] ">
                  ...
                  <input
                    className=" w-[96%] h-[36px]  outline-none placeholder:text-[#38761D] placeholder:tracking-[0.8px] placeholder:text-[14px] font-[300] 5xl:w-[1620px] 6xl:w-[95%] 4xl:w-[1120px] "
                    type="text"
