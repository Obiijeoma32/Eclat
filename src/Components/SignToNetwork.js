      ...
      <div className=" bg-[#fff] w-[100%] 6xxl:h-[150vh] h-[130vh]">
        ...
        <div className="pt-[7%] 3xxl:pt-[25%] 3xxl:ml-[0%] 10inch:ml-[25%] 6xxl:ml-[10%] 7xxl:ml-[15%] 6xxl:pt-[15%] 1xl:ml-[25%] 1halfxl:ml-[28%] 1halfxl:pt-[100px] 820xxl:ml-[20%] 820xxl:pt-[150px] pb-[20px] ml-[30%] 3xl:ml-[33%] 1xl:pt-[15%] 3xl:pt-[10%] 4xl:ml-[35%] 6xl:ml-[33%] 5xl:ml-[38%]">
          <div className="md:w-[512px] 3xxl:w-[85%]  h-[636px] ">
            <div className=" pt-5 ">
              <h4 className=" md:text-[30px] 3xxl:text-[24px] 3xxl:ml-[60px] md:ml-[0px] text-center text-[#1E2757] ">
              ...
              <div className="md:w-[466px] 3xxl:w-[100%] rounded-[4px] mt-[20px] items-center flex justify-between">
                <h3 className=" md:w-[200px] 3xxl:w-[50%] border-[1px] h-[0px] ml-[50px] border-[#DCDDE5] ">
                  {/* intentional break */}
                </h3>
                <h4 className=" text-[#181819] m-[7px] text-opacity-[42%] text-[14px]">
                  OR
                </h4>
                <h3 className=" md:w-[200px] 3xxl:w-[50%] border-[1px] h-[0px] border-[#DCDDE5] ">
                  {/* intentional break */}
                </h3>
              </div>
              <form autoComplete="on" className="ml-[3rem] mt-7" action="">
                ...
                <input
                  required
                  className=" md:w-[420px] 3xxl:w-[320px] mt-[11px]  mb-[15px] h-[50px] pl-[14px] border-[#DCDDE5] outline-none rounded-[5px]  border-[1px]   "
                  type="email"
                  placeholder=""
                  value={email}
                ...
                <Link
                  ...
                  to="/forgot-password"
                >
                  <div className="md:w-[420px] 3xxl:w-[320px] flex justify-end">
                ...
                > */}
                  <div
                    className="mt-[20px] tracking-[2px] md:w-[420px] 3xxl:w-[320px] rounded-[8px] h-[50px] bg-[#38761E] text-center pt-[13px] opacity-90 text-[#fff]"
                    onClick={handleLogin}
                  >
                    <h1>Sign In</h1>
                  </div>
