...
function TechExpert() {
  return (
    <>
      ...
      <div className=" md:hidden grid  ml-[1rem] w-[60%]  mt-[6rem] h-[600px] items-center justify-between ">
        <div className="  mt-[1rem] ">
          <div className="flex justify-between ml-[20px]">
            ...
            <img className=" w-[220px] mt-[25px]  h-[220px]" src={talentimg} alt="Eclat" />
          </div>
      ...
      <Partners />
      <div className="md:block hidden w-[80%] ml-[8rem] items-center mt-[7rem] 5xl:ml-[5%]">
        ...
        <div className=" mt-2 justify-between  flex">
          <div className="w-[700px]">
            <h1 className=" text-left  w-[550px] text-[48px] font-[600] text-[#222222]  ">Elevate your professional journey with our company.</h1>
            <p className="tracking-[1px] mt-3 w-[450px] font-[400] text-[#4f4f4f] text-left text-[16px]">
          ...
          <img className=" w-[400px] mt-[5rem] h-[300px]" src={team} alt="chatbox" />
        </div>{" "}
        ...
        <div className=" mt-2 justify-between  flex">
          <div className="mt-[7rem] w-[700px]">
            <h1 className=" text-left  w-[500px] text-[48px] font-[600] text-[#222222]  ">We bring Flexibility to work</h1>
            <ul className="tracking-[1px] mt-3  font-[400] text-[#4f4f4f] text-left text-[16px]">
          ...
          <img className=" w-[500px] mt-[5rem] h-[400px]" src={table} alt="chatbox" />
        </div>{" "}
      </div>
      <div className="md:hidden block w-[80%]  items-center mt-[4rem]">
        <div className="ml-[1rem]">
          ...
          <img className=" w-[450px] ml-[50px] mt-[35px] h-[350px]" src={team} alt="chatbox" />
          <p className="tracking-[1px] mt-[40px] ml-[8px] w-[470px] font-[400] text-[#4f4f4f] text-center text-[14px]">
            Collaborate with a globally dispersed team and corporation. Explore rewarding employment options with compelling organizations for extended periods. Acquire supplementary expertise through exclusive educational programs. Expand your
            skillset by networking.
          </p>
          <img className=" w-[450px] mt-[3rem] ml-[45px] h-[350px]" src={shakir} alt="Business manager" />
          ...
          <img className=" w-[550px] rounded-[50%] ml-[11%] mt-[3rem] h-[400px]" src={table} alt="chatbox" />
