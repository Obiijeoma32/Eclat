        ...
        <div className="md:hidden block w-[80%] 5xxl:w-[85%] 3xxl:w-[85%] 3xxl:ml-[10%] 1halfxl:hidden items-center mt-[4rem]">
          <div className="ml-[1rem]">
            ...
            <ul className="tracking-[1px] mt-3 ml-[25px] 3xxl:text-[10px] 5xxl:text-[12px]  font-[400] text-[#4f4f4f] text-left text-[16px]">
              ...
              <li className="flex items-center mb-1 w-[352px] 3xxl:w-[250px] 5xxl:w-[80%] justify-between">&#x2022; Expert career advice and guidance</li>
              <li className="flex items-center mb-1 w-[265px] 3xxl:w-[250px] 5xxl:w-[80%] justify-between">&#x2022; Specialized team building</li>
            </ul>
          </div>
        </div>
        <Steps />
