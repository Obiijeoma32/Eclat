  ...
  return (
    <>
      <div>
        ...
        <div className=" md:hidden grid  ml-[1rem] w-[60%] 3xxl:mt-[1rem] 3xxl:h-[780px] 3xxl:w-[90%]   mt-[6rem] h-[900px] items-center justify-between ">
          <div className="  mt-[1rem] ">
            <div className="grid justify-between ml-[30px]">
              <h1 className=" text-left  w-[400px] 3xxl:text-[16px] 3xxl:w-[80%] text-[28px] font-[600] text-[#000] opacity-80 ">Discover fulfilling employment opportunities with reputable organizations.</h1>
              <img className=" w-[400px] mt-[25px] 3xxl:w-[250px] 3xxl:h-[200px]   h-[300px]" src={talentimg} alt="Eclat" />
            </div>
        ...
        <div className="md:hidden block w-[80%] 3xxl:ml-[10%] 1halfxl:hidden items-center mt-[4rem]">
          <div className="ml-[1rem]">
            <svg className=" 3xxl:w-[50px] 3xxl:h-[70px] " width="70" height="90" viewBox="0 0 77 135" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M3.92849 1.46997C3.63576 0.404891 2.53504 -0.221217 1.46997 0.0715126C0.404891 0.364243 -0.221217 1.46496 0.0715126 2.53003L3.92849 1.46997ZM57.7713 79.5678L56.9642 77.7378L56.9642 77.7378L57.7713 79.5678ZM54.7518 57.4565L52.7946 57.045L54.7518 57.4565ZM75.6373 128.896C76.6843 128.544 77.2477 127.41 76.8957 126.363L71.1599 109.301C70.8079 108.254 69.6738 107.691 68.6268 108.043C67.5798 108.395 67.0164 109.529 67.3684 110.576L72.4669 125.742L57.301 130.84C56.254 131.192 55.6906 132.326 56.0426 133.373C56.3946 134.42 57.5287 134.984 58.5757 134.632L75.6373 128.896ZM0.0715126 2.53003C4.26975 17.805 12.1223 40.0874 22.0676 57.2426C27.0297 65.8021 32.6078 73.2538 38.6438 77.8802C44.7386 82.5518 51.5501 84.4974 58.5784 81.3977L56.9642 77.7378C51.7015 80.0589 46.4396 78.8157 41.0771 74.7055C35.6558 70.5502 30.3926 63.6274 25.5281 55.2364C15.8202 38.4906 8.07818 16.5683 3.92849 1.46997L0.0715126 2.53003ZM58.5784 81.3977C67.0105 77.6788 71.8281 69.7407 74.1848 61.438C76.543 53.13 76.5481 44.112 75.0621 37.6393C74.3292 34.4469 73.173 31.6022 71.5197 29.82C70.6699 28.904 69.59 28.165 68.2788 27.9379C66.9356 27.7053 65.6301 28.0582 64.4576 28.8122C62.2446 30.235 60.2415 33.2425 58.378 37.6717C56.476 42.1924 54.5849 48.5299 52.7946 57.045L56.709 57.868C58.471 49.4876 60.2988 43.4209 62.065 39.2229C63.8697 34.9334 65.4841 32.9076 66.6208 32.1767C67.1231 31.8538 67.4255 31.8497 67.5962 31.8793C67.7988 31.9144 68.1385 32.0567 68.5872 32.5404C69.5309 33.5576 70.4867 35.586 71.1635 38.5344C72.4972 44.3432 72.5134 52.6777 70.3368 60.3458C68.1588 68.0191 63.8959 74.6807 56.9642 77.7378L58.5784 81.3977ZM52.7946 57.045C47.095 84.1537 47.7225 99.9454 52.3306 110.118C56.9939 120.414 65.5761 124.551 74.1102 128.791L75.8898 125.209C67.1952 120.889 59.9696 117.288 55.9742 108.468C51.9235 99.5253 51.0413 84.8249 56.709 57.868L52.7946 57.045Z"
                fill="#0067DE"
              />
            </svg>
            <h1 className=" text-center 3xxl:w-[80%] 3xxl:text-[16px]  w-[480px] text-[28px] font-[600] text-[#222222]  ">Elevate your professional journey with our company.</h1>
            <img className=" w-[400px] ml-[90px] mt-[35px] 3xxl:w-[250px] 3xxl:h-[200px] 3xxl:ml-[0px] h-[300px]" src={team} alt="chatbox" />
            <p className="tracking-[1px] mt-[40px] ml-[8px] 3xxl:w-[80%] 3xxl:text-[10px] w-[470px] font-[400] text-[#4f4f4f] text-center text-[14px]">
              Collaborate with a globally dispersed team and corporation. Explore rewarding employment options with compelling organizations for extended periods. Acquire supplementary expertise through exclusive educational programs. Expand your
              skillset by networking.
            </p>
            <img className=" w-[400px] mt-[3rem] ml-[90px] 3xxl:w-[250px] 3xxl:h-[200px] 3xxl:ml-[0px] h-[300px]" src={shakir} alt="Business manager" />
            <h1 className=" text-center 3xxl:w-[80%] 3xxl:text-[16px]  w-[450px] mt-[2rem] text-[48px] font-[600] text-[#222222]  ">You decide what best suits you</h1>
            <ul className="tracking-[1px] ml-[30px] mt-3 3xxl:ml-[0px] 3xxl:text-[10px] font-[400] text-[#4f4f4f] text-left text-[16px]">
              ...
              <li className="flex items-center mb-1 w-[450px] 3xxl:w-[250px] justify-between"> &#x2022; Partner exclusively with companies that we have confidence in.</li>
              <li className="flex items-center mb-1 w-[450px] 3xxl:w-[250px] justify-between"> &#x2022; Obtain timely payments in either your local currency, USD, or cryptocurrency.</li>
            </ul>
            <img className=" w-[400px] 3xxl:w-[250px] 3xxl:h-[200px] 3xxl:ml-[0px] rounded-[50%] ml-[90px] mt-[3rem] h-[300px]" src={table} alt="chatbox" />
            <h1 className=" text-center mt-[20px]  3xxl:w-[80%] 3xxl:text-[16px] ml-[10px] w-[450px] text-[48px] font-[600] text-[#222222]  ">We bring Flexibility to work</h1>
            <ul className="tracking-[1px] mt-3 ml-[25px] 3xxl:text-[10px]  font-[400] text-[#4f4f4f] text-left text-[16px]">
              <li className="flex items-center mb-1 w-[270px] 3xxl:w-[250px] justify-between">&#x2022; Reliable ally Career growth</li>
              <li className="flex items-center mb-1 w-[190px] 3xxl:w-[250px] justify-between">&#x2022; High success rate</li>
              <li className="flex items-center mb-1 w-[375px] 3xxl:w-[250px] justify-between">&#x2022; Talent matched to ideal opportunities</li>
              <li className="flex items-center mb-1 w-[352px] 3xxl:w-[250px] justify-between">&#x2022; Expert career advice and guidance</li>
              <li className="flex items-center mb-1 w-[265px] 3xxl:w-[250px] justify-between">&#x2022; Specialized team building</li>
            </ul>
          </div>
        </div>
        <Steps />
