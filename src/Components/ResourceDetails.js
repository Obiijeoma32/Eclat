    ...
    <>
      ...
      <div className=" h-[200vh] 5xl:mt-[-5%] 820xxl:mt-[0] 3xxl:mt-[10%] flex 5xl:ml-[5%]">
        ...
        <div className=" mt-[12%] 4xl:ml-[24rem] 3xxl:ml-[1rem] 5xl:ml-[25rem] ml-[25rem] 820xxl:ml-[16rem] 1xl:ml-[22rem]">
          ...
          >
            <h1 className=" w-[471px] 820xxl:w-[471px] 3xxl:w-[300px] h-[50px] rounded-[5px] bg-[#38761D] pt-[15px] opacity-95 text-[#fff] text-center tracking-[2px] text-[14px] font-[400]  ">Continue</h1>
          </Link>
        </div>
      </div>
