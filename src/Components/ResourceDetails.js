      ...
      <div className=" h-[200vh] flex 5xl:ml-[5%]">
        ...
        <div className=" mt-[12%] ml-[25rem]">
          ...
          <div className=" mt-[40.5px] w-[550px] items-center text-center flex justify-center">
            <div className=" ">
              <svg className=" ml-[40px]" width="78" height="78" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M39 76.5C59.7107 76.5 76.5 59.7107 76.5 39C76.5 18.2893 59.7107 1.5 39 1.5C18.2893 1.5 1.5 18.2893 1.5 39C1.5 59.7107 18.2893 76.5 39 76.5Z" stroke="#DCDDE5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path
          ...
          <form className="mt-7" action="">
            ...
            <Select required placeholder="E.g  Front-End Developer" styles={customStyles} className=" mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] " options={options} />
            ...
            <br />
            <Select required placeholder="Select expertise level" styles={customStyles} className=" mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] " options={years} />
            ...
            <br />
            <Select placeholder="Select years of experience" styles={customStyles} className="  mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] " options={jobRole} />
            ...
            <br />
            <input
              className="text-[14px]  border-[#DCDDE5] border-[1px] rounded-[5px] bg-[#fafaf4] pl-[14px] mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] "
            ...
            <br />
            <input
              className="text-[14px]  border-[#DCDDE5] border-[1px] rounded-[5px] bg-[#fafaf4] pl-[14px] mb-[20px] w-[471px] h-[80px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] "
