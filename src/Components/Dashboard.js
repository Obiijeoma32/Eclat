  ...
  return (
    <>
      <div className=" 3xxl:overflow-x-hidden  dashboard">
        ...
        <div className=" xl:hidden 3xxl:grid   820xxl:w-[80%] 820xxl:ml-[110px]  820xxl:mt-[18%] lg:hidden 4xxl:grid 3xxl:mt-[0px] 3xxl:h-[570px]    3xxl:w-[85%] ml-[1rem] w-[60%]  mt-[6rem] h-[900px] items-center justify-between ">
          <div className=" 3xxl:mt-[3rem]  mt-[1rem] ">
            <div className="grid  justify-between 3xxl:ml-[0px] ml-[20px]">
              <h1 className=" text-left 3xxl:ml-[30px]  3xxl:w-[80%] 3xxl:text-center 3xxl:text-[16px]   w-[380px] 820xxl:w-[600px] 820xxl:text-center 820xxl:h-[130px] text-[38px] font-[600] text-[#000] opacity-80 ">
