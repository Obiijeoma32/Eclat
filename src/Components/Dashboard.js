  ...
  return (
    <>
      <div className=" 3xxl:overflow-x-hidden dashboard">
        ...
        <div className=" xl:hidden 3xxl:grid  3xxl:ml-[0px] 820xxl:w-[80%] 820xxl:ml-[110px]  820xxl:mt-[18%] lg:hidden 4xxl:grid 3xxl:mt-[2rem]    3xxl:w-[75%] ml-[1rem] w-[60%]  mt-[6rem] h-[900px] items-center justify-between ">
          <div className="  mt-[1rem] ">
            <div className="grid justify-between ml-[20px]">
              <h1 className=" text-left  3xxl:text-center 3xxl:text-[22px] 3xxl:w-[280px]  w-[380px] 820xxl:w-[600px] 820xxl:text-center 820xxl:h-[130px] text-[38px] font-[600] text-[#000] opacity-80 ">
                Uncovering exceptional talent across the globe.
              </h1>
              <img className=" 3xxl:w-[250px] max-w-full 3xxl:h-auto  w-[370px] 820xxl:w-[450px] 820xxl:h-[500px] 820xxl:ml-[60px]  mt-1  h-[420px]" src={dashimg} alt="Eclat" />
            </div>
            <p className="tracking-[1px] 3xxl:w-[280px] 3xxl:text-center 820xxl:w-[500px] 820xxl:text-center 820xxl:ml-[40px] mt-[40px] ml-[20px] w-[380px]  font-[400] text-[#000] opacity-80 text-left text-[16px]">
              Join Tech Eclat to assemble a top-tier team of developers, engineers, product designers, and exceptional remote technology experts..
            </p>
            <div className="flex w-[90%] 3xxl:w-[290px] 820xxl:w-[500px] 820xxl:ml-[50px] 820xxl:mt-[40px] ml-[25px] justify-between mt-[30px] ">
              <Link
                onClick={() => window.scrollTo(0, 0)}
                className="w-[170px] 3xxl:w-[140px] 820xxl:w-[230px] 820xxl:h-[50px] rounded-[5px] h-[45px]  text-[16px] bg-[#38761D] flex items-center justify-evenly opacity-95  font-[600] text-[#fff]"
                to="/eclatjobs"
              >
                Find Talent
                <svg className="mt-1" width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link onClick={() => window.scrollTo(0, 0)} className="w-[180px] 3xxl:w-[140px] 820xxl:w-[230px] 820xxl:h-[50px] h-[45px] rounded-[5px] text-[16px] bg-[#fff] flex items-center justify-evenly font-[600] text-[#38761D]" to="/jobs">
                Find Jobs
                <svg className="mt-1" width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.5 5H12M12 5L7.5 1M12 5L7.5 9.5" stroke="currentColor" strokeWidth="2" />
                </svg>
