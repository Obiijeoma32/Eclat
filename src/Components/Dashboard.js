  ...
  return (
    <>
      <div className=" 3xxl:overflow-x-hidden  dashboard">
        ...
        <div className=" xl:hidden 3xxl:grid 3xxl:ml-[20%]  820xxl:w-[80%] 820xxl:ml-[110px]  820xxl:mt-[18%] lg:hidden 4xxl:grid 3xxl:mt-[0px] 3xxl:h-[570px]    3xxl:w-[85%] ml-[1rem] w-[60%]  mt-[6rem] h-[900px] items-center justify-between ">
