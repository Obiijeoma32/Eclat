...
function Enterprise() {
  return (
    <>
      <EnterpriseDashboard />
      <Partners />
      <div className=" 7xxl:hidden 820xxl:hidden 1xl:flex hidden items-center mt-5 justify-between ml-[4rem] w-[85%] 1xl:w-[89%]  5xl:ml-[5%]">
      ...
      {/* small screens */}
      <div className=" 7xxl:block 3xxl:mt-[10px]  7xxl:ml-[12%] 3xxl:w-[85%]  grid 820xxl:block 1xl:hidden 820xxl:w-[750px] mt-[40px] justify-between ml-[40px] w-[380px]  ">
      ...
      <div className=" 7xxl:hidden 1xl:flex 820xxl:hidden hidden ml-[5rem] 2xl:w-[89%] w-[85%] 1xl:w-[89%]  mt-[6rem] h-[600px] items-center justify-between 5xl:ml-[5%]">
      ...
      <div className=" 7xxl:grid grid 10inch:ml-[10%] 10inch:h-[900px] 820xxl:grid 820xxl:w-[80%] 820xxl:ml-[20px] 3xxl:w-[88%] 3xxl:h-[750px]  3xxl:ml-[5%] 1xl:hidden ml-[40px] 3xxl:mt-[0px] w-[60%] 820xxl:h-[1200px]  mt-[6rem] h-[900px] items-center justify-between ">
