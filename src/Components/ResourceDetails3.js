...
function ResourceDetails3() {
  ...
  const handleSign3Click = async () => {
    ...
    fetch(
      `http://nubeero-deployment-server.uksouth.cloudapp.azure.com:9009/api/Eclat/user/${userId}/signUp4`,
      requestOptions
    )
    ...
    <>
      ...
      <div className=" h-[200vh] 10inch:ml-[0%] 3xxl:mt-[10%] 6xxl:w-[90%] 6xxl:mt-[0px] 5xl:mt-[-5%] 820xxl:mt-[0] flex 5xl:ml-[5%]">
        ...
        <div className="5xl:ml-[25rem] 4xl:ml-[24rem] 6xxl:w-[85%]  mt-[12%] 3xxl:ml-[1rem] 820xxl:ml-[16rem] ml-[25rem] 1xl:ml-[22rem]">
          <h1 className=" 3xxl:w-[300px] 6xxl:w-[90%] 820xxl:w-[600px] text-[#38761D] 3xxl:text-[20px] 820xxl:text-[30px] font-[600] opacity-80 ">
          ...
          <form className="mt-7" action="">
            <label
              className=" 3xxl:w-[200px] 3xxl:text-[10px] 820xxl:3xxl:text-[10px] 820xxl:text-[16px] text-[#1E2757]"
              htmlFor="company"
            >
            ...
            <div className="  3xxl:w-[320px] 6xxl:w-[90%] 4xl:w-[900px] 820xxl:w-[471px] 5xl:w-[900px]  w-[471px]">
              <div>
                <label
                  className=" 3xxl:w-[100px]  3xxl:text-[10px] 820xxl:text-[16px] text-[#1E2757]"
              ...
              <div>
                <label
                  className=" 3xxl:text-[10px] 820xxl:text-[16px] 3xxl:w-[100px] text-[#1E2757]"
                  htmlFor="period of employment"
                >
                  Year of graduation ?
                </label>
          ...
          > */}
          <h1
            className="3xxl:w-[300px] 6xxl:w-[90%] 820xxl:w-[471px] w-[471px] h-[50px] rounded-[5px] bg-[#38761D] pt-[15px] opacity-95 text-[#fff] text-center tracking-[2px] text-[14px] font-[400]  "
