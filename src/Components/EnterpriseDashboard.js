...
function EnterpriseDashboard() {
  return (
    <>
      ...
      <div className="md:hidden 820xxl:block  3xxl:w-[82%] 3xxl:h-[570px] grid h-[1000px] 1xl:hidden 820xxl:h-[1100px] 820xxl:mt-[8rem] mt-[7rem] 820xxl:w-[750px]  ml-[60px] w-[400px]  ">
        <div>
          <h1 className="  820xxl:text-[38px] 3xxl:text-[16px] 3xxl:w-[70%] 820xxl:w-[700px] font-[700px] w-[380px] text-left text-[#000000]">
            Our mission is to support you in forming an outstanding team that is globally recognized for its excellence.
          </h1>
          <p className=" text-[18px] w-[380px] 3xxl:hidden 820xxl:hidden mt-[15px] font-[400] text-left text-[#000] ">
            Tech Eclat is a trusted partner for both enterprise teams and emerging startups. Our onboarding durations are 75% quicker than the industry standard.
          </p>
          <img className=" mt-[30px] w-[380px] 3xxl:w-[250px] 3xxl:h-[200px] 820xxl:w-[700px] 820xxl:h-[600px]  h-[320px]" src={enterprise} alt="enterprise" />
          <p className=" text-[18px] 3xxl:w-[70%] 3xxl:text-[10px] w-[380px] 820xxl:block 820xxl:text-[18px] 820xxl:w-[700px] mt-[15px] font-[400] text-left text-[#000] ">
            Tech Eclat is a trusted partner for both enterprise teams and emerging startups. Our onboarding durations are 75% quicker than the industry standard.
          </p>

          <div className="flex justify-between 3xxl:w-[80%] w-[380px] 820xxl:w-[650px] items-center mt-[2rem] ">
            <Link to="">
              <div className=" 820xxl:text-[14px] 3xxl:w-[120px] 3xxl:text-[10px] font-[400] text-center text-[#fff] flex justify-evenly items-center rounded-[5px] pt-[px] 820xxl:w-[186px] h-[48px] bg-[#38761D] ">
                <h1>Schedule a Call</h1>
                <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.5 5H12M12 5L7.5 1M12 5L7.5 9.5" stroke="white" strokeWidth="2" />
                </svg>
            ...
            <Link to="">
              <h1 className=" 820xxl:text-[14px] 3xxl:pt-[15px] 3xxl:w-[120px] 3xxl:text-[10px]  font-[400] text-center text-[#38761D] rounded-[5px] pt-[10px] 820xxl:w-[186px] h-[48px] border-[1px] border-[#5E8F48] ">Watch an Overview</h1>
            </Link>
          </div>
        </div>
      </div>
