...
function EnterpriseDashboard() {
  return (
    <>
      <Heading />
      <div className="md:flex hidden h-[550px] mt-[12%]  justify-between ml-[5%] w-[90%]  ">
        <div>
      ...
      <div className="md:hidden grid h-[1000px] mt-[7rem]  ml-[60px] w-[400px]  ">
        <div>
          <h1 className="  text-[38px] font-[700px] w-[380px] text-left text-[#000000]">Our mission is to support you in forming an outstanding team that is globally recognized for its excellence.</h1>
          <p className=" text-[18px] w-[380px] mt-[15px] font-[400] text-left text-[#000] ">Tech Eclat is a trusted partner for both enterprise teams and emerging startups. Our onboarding durations are 75% quicker than the industry standard.</p>
          <img className=" mt-[30px] w-[380px]  h-[320px]" src={enterprise} alt="enterprise" />
          <div className="flex justify-between w-[380px] items-center mt-[2rem] ">
            <Link to="">
              <div className=" text-[14px]  font-[400] text-center text-[#fff] flex justify-evenly items-center rounded-[5px] pt-[px] w-[186px] h-[48px] bg-[#38761D] ">
                <h1>Schedule a Call</h1>
                <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
