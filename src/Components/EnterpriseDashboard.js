...
function EnterpriseDashboard() {
  return (
    <>
      ...
      {/* small screens */}
      <div className="md:hidden 820xxl:block 6xxl:w-[85%] 6xxl:h-[900px] 6xxl:ml-[13%]  3xxl:w-[82%] 3xxl:h-[570px] grid h-[1000px] 1xl:hidden 820xxl:h-[1100px] 820xxl:mt-[8rem] mt-[7rem] 820xxl:w-[750px]  ml-[60px] w-[400px]  ">
        <div>
