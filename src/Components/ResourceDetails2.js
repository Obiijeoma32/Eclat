  ...
  return (
    <>
      ...
      <div className=" h-[200vh] flex  5xl:ml-[5%]">
        <SideBar />
        <div className=" mt-[12%] 820xxl:ml-[16rem] 1xl:ml-[22rem] ml-[25rem]">
          ...
          <form className="mt-7" action="">
            ...
            <br />
            <Select required placeholder="Select your employment status" styles={customStyles} className=" mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] " options={employmentStatus} />
            <label className=" text-[16px] text-[#1E2757]" htmlFor="company">
              What is the name of your company ?
            </label>

            <br />
            <input className="text-[14px]  border-[#DCDDE5] border-[1px] rounded-[5px] bg-[#fafaf4] pl-[14px] mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] " placeholder="E.g  Google" type="text" />
            <br />
            ...
            <br />
            <input className="text-[14px]  border-[#DCDDE5] border-[1px] rounded-[5px] bg-[#fafaf4] pl-[14px] mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] " placeholder="E.g  Fintech" type="text" />
            <br />
            <label className=" text-[16px] text-[#1E2757]" htmlFor="industry">
              What is your job title ?
            </label>
            <br />
            <input className="text-[14px]  border-[#DCDDE5] border-[1px] rounded-[5px] bg-[#fafaf4] pl-[14px] mb-[20px] w-[471px] h-[50px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] " placeholder="E.g  Graphics Designer" type="text" />
            ...
            <br />
            <label className=" text-[16px] text-[#1E2757]" htmlFor="role">
              Give a brief description about your job role ?
            </label>
            <br />
            <textarea
              className="text-[14px] pt-[14px]  border-[#DCDDE5] border-[1px] rounded-[5px] bg-[#fafaf4] pl-[14px] mb-[20px] w-[471px] h-[80px]  mt-[11px] text-[#7D90B8]  outline-none  2xl:w-[900px] "
