...
function Unlock() {
  return (
    <>
      <div className="md:block hidden w-[80%] ml-[8rem] items-center mt-[7rem]">
        ...
        <div className=" mt-2 justify-between  flex">
          <div className="w-[700px] ">
            <h1 className=" text-left  w-[500px] text-[48px] font-[600] text-[#222222]  ">Unlock the secret to building high-performing engineering teams.</h1>
            <p className="tracking-[1px] mt-3 w-[450px] font-[400] text-[#4f4f4f] text-left text-[15px]">
          ...
          <img className=" w-[400px] mt-[5rem] h-[300px]" src={chatbox} alt="chatbox" />
        </div>
        <div className="mt-5 justify-between  flex">
          <img className=" w-[450px] mt-[5rem] h-[350px]" src={face} alt="Business manager" />
          <div>
            <h1 className=" text-left  w-[500px] text-[48px] font-[600] text-[#222222]  ">Here’s why top talent worldwide chooses Tech Eclat</h1>
      ...
      <div className="md:hidden block w-[80%] ml-[3rem] items-center mt-[5rem]">
        ...
        <div className=" mt-2 ml-[40px] grid">
          <div className="w-[400px]">
            <h1 className=" text-left  w-[390px] text-[38px] font-[600] text-[#222222]  ">Unlock the secret to building high-performing engineering teams.</h1>
          </div>
          <img className=" w-[350px] mt-[2rem] h-[250px]" src={chatbox} alt="chatbox" />
          <p className="tracking-[1px] mt-[40px] w-[350px] font-[400] text-[#4f4f4f] text-left text-[14px]">
            Achieve your staffing goals promptly and efficiently with Eclat's proven expertise in engineering team creation. Access a pool of highly skilled engineers, product managers, and designers, along with a broad range of technical services
            tailored to your specific business requirements. Leverage Eclat's talent to build your world-class team swiftly and effectively.
          </p>
        </div>
        <div className="mt-[20px] grid">
          <img className=" w-[400px] mt-[1rem]  h-[300px]" src={face} alt="Business manager" />
          <div>
            <h1 className=" text-left  w-[450px] text-[40px] font-[600] text-[#222222]  ">Here’s why top talent worldwide chooses Tech Eclat</h1>
            <ul className="tracking-[1px] mt-3  font-[400] text-[#4f4f4f] text-left text-[16px]">
              <li className="flex items-center mb-1 w-[280px] justify-between">
                <svg width="5" height="5" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 30C23.2843 30 30 23.2843 30 15C30 6.71573 23.2843 0 15 0C6.71573 0 0 6.71573 0 15C0 23.2843 6.71573 30 15 30Z" fill="currentColor" />
