    ...
    <>
      ...
      <div className="flex  5xl:ml-[5%]">
        ...
        <div className=" mt-[12%] ml-[25rem]">
          <h1 className=" text-[#38761D] text-[30px] font-[600] opacity-80 ">Confirm the resource</h1>
          ...
          <form className="mt-7" action="">
            ...
            <br />
            <Select placeholder="Select the role you would like to hire" styles={customStyles} className="w-[640px]    mt-2 text-[#38761D]  outline-none  5xl:w-[1220px] 4xl:w-[920px]" options={jobRole} />
            <br />
            ...
            <br />
            <Select placeholder="Select the skills required" styles={customStyles} className=":w-[640px]    mt-2 text-[#38761D]     outline-none  5xl:w-[1220px] 4xl:w-[920px]" options={options} />
            <br />
            ...
            <br />
            <Select placeholder="Select the job type" styles={customStyles} className="w-[640px]    mt-2 text-[#38761D]     outline-none  5xl:w-[1220px] 4xl:w-[920px]" options={jobType} />
            <br />
            ...
            <br />
            <Select placeholder="Select the experience level you need" styles={customStyles} className="w-[640px]    mt-2 text-[#38761D]     outline-none  5xl:w-[1220px] 4xl:w-[920px]" options={years} />
          </form>

          <div className=" flex justify-end w-[640px] mb-6  mt-[3rem] 5xl:w-[1220px] 4xl:w-[920px]">
            <Link className="" to="">
